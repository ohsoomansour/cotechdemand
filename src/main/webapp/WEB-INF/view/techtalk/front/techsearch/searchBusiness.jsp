				...
				<div class="wrap_cont">
					<div class="sch_ctgr_wrap">
						<ul class="sch_ctgr_link">
							<li class="sch_ctgr_item item_type "><a href="#none">연구자 검색<span class="ir_text check-text">(선택됨)</span></a></li>
							<li class="sch_ctgr_item item_author active"><a href="#none">기업수요 검색</a></li>
						</ul>
					</div>
