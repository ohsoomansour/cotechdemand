...
<head>
	...
	<!-- color picker -->
	<script src="${pageContext.request.contextPath}/js/jquery.minicolors.js?v=1" ></script>
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/admin/jquery.minicolors.css?v=1">
</head>
